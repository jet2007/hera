...
datax_paras="-Dreader_username='$SOURCE_SERVER_USERNAME' \
            -Dreader_password='$SOURCE_SERVER_PASSWORD' \
            -Dreader_jdbcurl='$SOURCE_SERVER_JDBC' \
            -Dreader_querySql=\"$source_querySql\""

datax_paras="${datax_paras} \
            -Dwriter_username='$TARGET_SERVER_USERNAME' \
            -Dwriter_password='$TARGET_SERVER_PASSWORD' \
            -Dwriter_jdbcUrl='$TARGET_SERVER_JDBC'  \
